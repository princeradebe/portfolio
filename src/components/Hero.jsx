    ...
    return (
        <>
            <div className='mt-24 px-4'>
                <h1 className='text-5xl md:text-[12rem] md:leading-[9rem] font-bold md:font-semibold text-transparent bg-clip-text bg-gradient-to-r to-brand-light-blue from-brand-magenta '>
                ...
                <h1 className='relative mt-2 pl-2 md:pl-4 text-3xl md:text-9xl font-bold md:font-semibold text-white border-brand-light-blue border-[1px] md:border-2 w-10/12'>
                    & UI/UX Designer
